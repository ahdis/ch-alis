...
* SoftwareReleaseNumber 0..1 http://fhir.ch/ig/ch-alis/StructureDefinition/Text "1.9, Version Standardschnittstelle des exportierendes Systems, Alphanum. (30), Version der betriebenen Software des Senders, Optional"
...
* Visit 0..* http://fhir.ch/ig/ch-alis/StructureDefinition/Visit "2, Patient"