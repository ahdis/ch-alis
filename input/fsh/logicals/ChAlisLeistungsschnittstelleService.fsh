...
* ServiceItem 1..1 http://fhir.ch/ig/ch-alis/StructureDefinition/Text "3.6, Tarifposition, Alphanum. 20 Zeichen, Nummer (Identifikation der Leistung, TARMED, SLK, interner Katalog), Obligatorisch"
