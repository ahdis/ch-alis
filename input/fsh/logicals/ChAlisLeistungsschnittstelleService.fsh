...
* OrderDate 0..1 http://fhir.ch/ig/ch-alis/StructureDefinition/Text "5.0 neu Attribute Auftragsdatum (OrderDate) für Laborleistungen"
...
* Costweight 0..1 http://fhir.ch/ig/ch-alis/StructureDefinition/Decimal "3.13, Anzahl, Numerisch mit Floatingpoint, (d.h. Nachkommastellen sind möglich), eine negative Leistung ist möglich (+ / -), gebrochene Werte müssen beim Import in Systeme die nur ganzzahlige Mengen akzeptieren mit dem Wert aus dem Parameter <NumberofParticipants> auf eine ganze Zahl umgerechnet werden, Obligat; negative Werte sind zu vereinbaren"
...
* Procedure 0..* http://fhir.ch/ig/ch-alis/StructureDefinition/Procedure "5.0 neu"